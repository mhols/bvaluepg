...
\title[Poisson \(\to\) P\'olya–Gamma]{From Poisson to P\'olya–Gamma in Spatial Models}
\author[T. Luhdo]{Toni Luhdo}
\institute[UP]{University of Potsdam}
\date[Habana Cuba - March 7, 2026]{Encuentro de Estadisticos @ ICIMAF Habana, March 7, 2026}
...
\hspace{-1.2cm}
  \begin{minipage}[h]{0.99\textwidth}
    \begin{figure}
      \includegraphics[width=1.2\textwidth]{figures/figure_1.png}
    \end{figure}
  \end{minipage}
\end{frame}
...
\begin{frame}{Observed Counts power scale}
 \hspace{-1.2cm} 
  \begin{minipage}[h]{0.99\textwidth}
    \begin{figure}
      \includegraphics[width=1.2\textwidth]{figures/figure_2.png}
    \end{figure}
  \end{minipage}
\end{frame}
